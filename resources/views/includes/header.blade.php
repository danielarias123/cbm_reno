<section id = "nav-header">
	...
	<div class = "main-navbar-container">
		<ul id = "main-navbar" class = "hidden-xs hidden-sm">
		...
		<div class="dropdown" id="menu-mobile">
			<div class="dropdown-toggle navbar-toggle" type="button" id="dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"  style = "z-index:99999">
				<span class="glyphicon glyphicon-menu-hamburger"></span>
			</div>
			<ul class="dropdown-menu" id="main-menu-dropdown" aria-labelledby="dropdownMenu">
				<a href = "/"><li class="{{ Request::is('/') ? 'active-link' : '' }}">Home</li></a>
				<a href = "/ourservices"><li class="{{ Request::is('ourservices') ? 'active-link' : '' }}">Our Services</li></a>
				<a href = "/projects"><li class="{{ Request::is('projects') ? 'active-link' : '' }}">Projects</li></a>
				<a href = "/ourstory"><li class="{{ Request::is('ourstory') ? 'active-link' : '' }}">Our Story</li></a>
	...
	<div id = "phone-section" class = "hidden-xs hidden-sm"><span class="glyphicon glyphicon-earphone" style = "vertical-align: text-top;" aria-hidden="true"></span>&nbsp;<a href ="tel:647-785-7125">647 785 7125</a></div>
